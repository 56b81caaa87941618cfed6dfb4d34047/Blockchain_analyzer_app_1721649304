...
Vue.component("quoty_faq_accordion_component_1721649388", {
    template: `
    ...
    data() {
        return {
            terms: [
                { title: "What is this app for?", description: "Our app allows you to analyze and gain insights from new blockchain data in real-time. It monitors the latest transactions, smart contracts, and other activity happening on various blockchain networks.", expanded: false },
                { title: "How does the analysis work?", description: "We use advanced algorithms and machine learning models to parse and interpret raw blockchain data. This extracts valuable information like transaction patterns, token flows, contract interactions, and more.", expanded: false },
                { title: "What blockchains are supported?", description: "Currently we support analysis for Ethereum, Bitcoin, Solana, and Polygon blockchains. However, we are continuously working to add support for more networks based on user demand.", expanded: false },
                { title: "How can I access the analysis?", description: "The app provides a user-friendly dashboard to view real-time analytics and insights derived from the blockchain data analysis. You can also integrate our APIs to build custom applications and services.", expanded: false },
            ],
        };
    },
    methods: {
